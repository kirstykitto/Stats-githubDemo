...
The relationship between height and BMI shows a moderate negative correlation. 
As height increases, BMI decreases. 

The evidence of this correlation is given by the p-value < 0.05

```{r}
#Code blocks can go inside these quoted delimeters
cor(newStarwars$height, newStarwars$BMI)

cor.test(newStarwars$height, newStarwars$BMI) 
